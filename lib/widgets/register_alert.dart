...
class RegisterAlert extends StatelessWidget {
  const RegisterAlert({Key? key, required this.continueCallback, required this.secret}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: Theme.of(context).textTheme.headline3?.copyWith(color: CustomColors.cultured),
        ),
        SizedBox(
